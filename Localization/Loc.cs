...
public sealed class Loc : INotifyPropertyChanged
{
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["HotkeysKey"] = "Key:",
        ["HotkeysKeyHint"] = "(Click and press a key — Esc clears)",
        ["HotkeysKeyTooltip"] = "Click and press a key to set. Esc, Delete or Backspace clears it.",
    ...
    private static readonly Dictionary<string, string> Pt = new()
    {
        ...
        ["HotkeysKey"] = "Tecla:",
        ["HotkeysKeyHint"] = "(Clique e pressione uma tecla — Esc limpa)",
        ["HotkeysKeyTooltip"] = "Clique e pressione uma tecla para definir. Esc, Delete ou Backspace limpa.",
